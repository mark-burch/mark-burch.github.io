...
export function Covalent(props: LogoProps) {
  return (
    ...
    >
      <path
        fill="#C9F06B"
        d="M84.755 38.216A43.197 43.197 0 1 0 84.755 61.784L65.984 57.687A24.049 24.049 0 1 1 65.984 42.313ZM85.019 84.266A7.491 7.491 0 1 0 100 84.266A7.491 7.491 0 1 0 85.019 84.266Z"
      />
    </svg>
  );
}
