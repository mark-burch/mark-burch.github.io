        ...
        <div className="flex items-center justify-between gap-2">
          <div className="flex flex-wrap gap-1.5">
            {item.techStack?.map((tech) => (
              <span
                key={tech}
                className="text-xs inline-flex items-center font-medium bg-slate-100 text-slate-600 dark:bg-slate-700 dark:text-slate-300 rounded-full text-center px-2 h-5"
              >
                {tech}
              </span>
            ))}
